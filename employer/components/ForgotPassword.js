      ...
      <div className={classes.card_center}>
        ...
        <Card className={classes.card}>
          <div>
              ...
              <Typography className={classes.card_heading}>Forgot Password</Typography>              
          </div>
          <div>
            <TextField
          ...
          />  
            <Box display="flex">
            <Box flexGrow={1}>
              <Typography className={classes.b_text}>Resend OTP</Typography>          
            </Box>
            <Box >
              <Typography className={classes.b_text}>Change Number</Typography>          
            </Box>
          </Box>
          </div>
          <div>
